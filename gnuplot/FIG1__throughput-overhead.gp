...
set key font ",15"
plot 'FIG1__throughput-overhead.dat' using 2 ls 1 fs pattern 2 title "Remus",\
'FIG1__throughput-overhead.dat' using 3 ls 2 fs pattern 4 title "vSphere", \
'FIG1__throughput-overhead.dat' using 4 ls 3 fs pattern 5 title "xxx"